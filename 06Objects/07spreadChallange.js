...
function findPriceExtremes(arr){
   ...
   const finalArray = [...averageSharePriceByMonthQ1, ...averageSharePriceByMonthQ2, ...averageSharePriceByMonthQ3, ...averageSharePriceByMonthQ4]
/*
Challenge:
...
*/
    const highest = Math.max(...finalArray) //???
    const lowest = Math.min(...finalArray)//???
